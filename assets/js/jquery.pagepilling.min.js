...
(function($) {
	...
	$('.pagepiling').pagepiling({
		anchors: ['OnepageFirstSection', 'OnepageSecondSection', 'OnepageThirdSection', 'OnepageFourthSection', 'OnepageFifthSection', 'OnepageSixthSection', 'OnepageSeventhSection'],
		menu: '#section-menu',
